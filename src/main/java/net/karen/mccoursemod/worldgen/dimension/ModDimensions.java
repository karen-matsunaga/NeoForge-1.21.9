package net.karen.mccoursemod.worldgen.dimension;
...
public class ModDimensions {
    ...
    public static final ResourceKey<LevelStem> KAUPENDIM_KEY =
           ...
           ResourceLocation.fromNamespaceAndPath(MccourseMod.MOD_ID, "kaupendim"));
    ...
    public static final ResourceKey<DimensionType> KAUPEN_DIM_TYPE =
           ...
           ResourceLocation.fromNamespaceAndPath(MccourseMod.MOD_ID, "kaupendim_type"));

    // CUSTOM METHOD - Register all custom DIMENSION TYPES (Data Generation) -> JSON file
    public static void bootstrapType(BootstrapContext<DimensionType> context) {
        context.register(KAUPEN_DIM_TYPE, new DimensionType(OptionalLong.of(12000), // fixedTime
                                                            false, // hasSkylight
                                                            false, // hasCeiling
                                                            false, // ultraWarm
                                                            false, // natural
    ...
    public static void bootstrapStem(BootstrapContext<LevelStem> context) {
        ...
        NoiseBasedChunkGenerator wrappedChunkGenerator =
             new NoiseBasedChunkGenerator(new FixedBiomeSource(biomeRegistry.getOrThrow(ModBiomes.TEST_BIOME_2)),
