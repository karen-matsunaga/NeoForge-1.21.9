...
//        {
//            guiGraphics.pose().translate(x, y, new Matrix3x2f());
...
//
//        if (amount > 0 && scaledAmount < MIN_FLUID_HEIGHT) { scaledAmount = MIN_FLUID_HEIGHT; }
...
//    }
//
//    private static void drawTiledSprite(GuiGraphics guiGraphics, final int tiledWidth, final int tiledHeight,
...
//        tessellator.addVertex(matrix, xCoord, yCoord + 16, zLevel).setUv(uMin, vMax);
//        tessellator.addVertex(matrix, xCoord + 16 - maskRight, yCoord + 16, zLevel).setUv(uMax, vMax);
//        tessellator.addVertex(matrix, xCoord + 16 - maskRight, yCoord + maskTop, zLevel).setUv(uMax, vMin);
//        tessellator.addVertex(matrix, xCoord, yCoord + maskTop, zLevel).setUv(uMin, vMin);
//
//    }
//
...
//                       Component.translatable("mccoursemod.tooltip.liquid.amount.with.capacity",
//                                              nf.format(milliBuckets), nf.format(capacity));
//                tooltip.add(amountString.withStyle(ChatFormatting.GRAY));
//            }
//            else if (tooltipMode == TooltipMode.SHOW_AMOUNT) {
//                MutableComponent amountString =
//                       Component.translatable("mccoursemod.tooltip.liquid.amount", nf.format(milliBuckets));
//                tooltip.add(amountString.withStyle(ChatFormatting.GRAY));
//            }
