...
public class TopElevatorBlock extends Block {
    public TopElevatorBlock(Properties properties) {
        super(properties);
    }
    ...
    public static void blockUp(Player player) {
        ...
        if (state.getBlock() == ModBlocks.TOP_ELEVATOR.get()) {
    ...
    private static void teleportPlayerUp(Player player, BlockPos pos) {
        ...
        while (!foundElevator && world.getBlockState(targetPos).getBlock() != ModBlocks.TOP_ELEVATOR.get()) {
            ...
            if (world.getBlockState(targetPos).getBlock() == ModBlocks.TOP_ELEVATOR.get()) {
                foundElevator = true;
            }
        }
