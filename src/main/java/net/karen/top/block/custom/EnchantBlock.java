...
public class EnchantBlock extends Block {
    ...
    private static void groupEnchant(List<ItemEntity> list, Map<Holder<Enchantment>,
                                     Integer> combine, Item drop, Level level, BlockPos pos) {
        list.forEach(item -> {
    ...
    private static void dropItem(Level level, BlockPos pos, ItemStack stack) {
        ItemEntity item = new ItemEntity(level, pos.getX() + 0.5,
