...
import net.karen.top.util.InventoryUtil;
...
public class MetalDetectorItem extends Item {
    ...
    private void outputNoValuableFound(Player player) {
        playerDisplayTranslatable(player, "item." + top + "metal_detector.no_valuable_values");
    }
    ...
    public String metalDetectorShiftDescription() {
        if (Minecraft.getInstance().hasShiftDown()) { return "tooltip.item." + top + "metal_detector.shift"; }
        else { return "tooltip.item." + top + "metal_detector"; }
    }
}