...
public class ModRecipes {
    ...
    public static final DeferredRegister<RecipeSerializer<?>> SERIALIZERS =
           DeferredRegister.create(Registries.RECIPE_SERIALIZER, Top.MOD_ID);

    // Registry all custom recipe types
    public static final DeferredRegister<RecipeType<?>> RECIPE_TYPES =
           DeferredRegister.create(Registries.RECIPE_TYPE, Top.MOD_ID);
    ...
    public static final DeferredHolder<RecipeSerializer<?>, RecipeSerializer<GemEmpoweringStationRecipe>>
           GEM_EMPOWERING_STATION_SERIALIZER = SERIALIZERS.register("gem_empowering_station",
                                                                    GemEmpoweringStationRecipe.Serializer::new);
    ...
    public static final DeferredHolder<RecipeType<?>, RecipeType<GemEmpoweringStationRecipe>>
           GEM_EMPOWERING_STATION_TYPE =
           RECIPE_TYPES.register("gem_empowering_station", () -> new RecipeType<>() {
               @Override
               public String toString() {
                   return "gem_empowering_station";
               }
           });
