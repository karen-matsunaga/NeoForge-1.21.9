...
import net.karen.top.block.custom.CattailCropBlock;
import net.karen.top.block.custom.KohlrabiCropBlock;
import net.karen.top.block.custom.RadishCropBlock;
...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        dropSelf(ModBlocks.TOP_ELEVATOR.get());
        dropSelf(ModBlocks.TOP_GENERATOR.get());
        ...
        // BISMUTH ores
        add(ModBlocks.BISMUTH_ORE.get(), _ -> createOreDrop(ModBlocks.BISMUTH_ORE.get(), ModItems.RAW_BISMUTH.get()));

        add(ModBlocks.BISMUTH_DEEPSLATE_ORE.get(), _ -> createMultipleOreDrops(ModBlocks.BISMUTH_DEEPSLATE_ORE.get(),
                                                                                     ModItems.RAW_BISMUTH.get(),
                                                                                     2, 5));

        add(ModBlocks.BISMUTH_END_ORE.get(), _ -> createMultipleOreDrops(ModBlocks.BISMUTH_END_ORE.get(),
                                                                               ModItems.RAW_BISMUTH.get(), 3, 6));

        add(ModBlocks.BISMUTH_NETHER_ORE.get(), _ -> createMultipleOreDrops(ModBlocks.BISMUTH_NETHER_ORE.get(),
                                                                                  ModItems.RAW_BISMUTH.get(), 4, 8));

        // ALEXANDRITE ores
        add(ModBlocks.ALEXANDRITE_ORE.get(), _ -> createOreDrop(ModBlocks.ALEXANDRITE_ORE.get(), ModItems.RAW_ALEXANDRITE.get()));

        add(ModBlocks.DEEPSLATE_ALEXANDRITE_ORE.get(),
            _ -> createMultipleOreDrops(ModBlocks.DEEPSLATE_ALEXANDRITE_ORE.get(),
                                              ModItems.RAW_ALEXANDRITE.get(), 2, 5));

        add(ModBlocks.END_STONE_ALEXANDRITE_ORE.get(),
            _ -> createMultipleOreDrops(ModBlocks.END_STONE_ALEXANDRITE_ORE.get(),
                                              ModItems.RAW_ALEXANDRITE.get(), 3, 6));

        add(ModBlocks.NETHER_ALEXANDRITE_ORE.get(),
            _ -> createMultipleOreDrops(ModBlocks.NETHER_ALEXANDRITE_ORE.get(),
                                              ModItems.RAW_ALEXANDRITE.get(), 4, 8));

        // PINK ores
        add(ModBlocks.PINK_ORE.get(), _ -> createOreDrop(ModBlocks.PINK_ORE.get(), ModItems.PINK.get()));

        add(ModBlocks.DEEPSLATE_PINK_ORE.get(),
            _ -> createMultipleOreDrops(ModBlocks.DEEPSLATE_PINK_ORE.get(), ModItems.PINK.get(), 2, 5));

        add(ModBlocks.END_STONE_PINK_ORE.get(),
            _ -> createMultipleOreDrops(ModBlocks.END_STONE_PINK_ORE.get(), ModItems.PINK.get(), 3, 6));

        add(ModBlocks.NETHER_PINK_ORE.get(),
            _ -> createMultipleOreDrops(ModBlocks.NETHER_PINK_ORE.get(), ModItems.PINK.get(), 4, 8));

        // Block families
        // BISMUTH
        dropSelf(ModBlocks.BISMUTH_STAIRS.get());
        add(ModBlocks.BISMUTH_SLAB.get(), _ -> createSlabItemTable(ModBlocks.BISMUTH_SLAB.get()));
        ...
        add(ModBlocks.BISMUTH_DOOR.get(), _ -> createDoorTable(ModBlocks.BISMUTH_DOOR.get()));

        // ALEXANDRITE
        dropSelf(ModBlocks.ALEXANDRITE_STAIRS.get());
        // Slabs - Drops are different because to put twice blocks
        add(ModBlocks.ALEXANDRITE_SLABS.get(), _ -> createSlabItemTable(ModBlocks.ALEXANDRITE_SLABS.get()));
        ...
        add(ModBlocks.ALEXANDRITE_DOOR.get(), _ -> createDoorTable(ModBlocks.ALEXANDRITE_DOOR.get()));
        ...
        this.add(ModBlocks.WALNUT_SIGN.get(), _ -> createSingleItemTable(ModItems.WALNUT_SIGN.get()));
        this.add(ModBlocks.WALNUT_WALL_SIGN.get(), _ -> createSingleItemTable(ModItems.WALNUT_SIGN.get()));
        this.add(ModBlocks.WALNUT_HANGING_SIGN.get(), _ -> createSingleItemTable(ModItems.WALNUT_HANGING_SIGN.get()));
        this.add(ModBlocks.WALNUT_WALL_HANGING_SIGN.get(), _ -> createSingleItemTable(ModItems.WALNUT_HANGING_SIGN.get()));
        ...
        this.dropSelf(ModBlocks.KAUPEN_FURNACE.get());
    }
