...
import net.karen.top.recipe.CraftingPlusRecipeBuilder;
import net.karen.top.recipe.GemEmpoweringStationRecipeBuilder;
import net.karen.top.recipe.GrowthChamberRecipeBuilder;
import net.karen.top.recipe.KaupenFurnaceRecipeBuilder;
...
public class ModRecipeProvider extends RecipeProvider {
    ...
    public static class Runner extends RecipeProvider.Runner {
        ...
        @Override
        public @NotNull String getName() { return splitWord(itemLines(Top.MOD_ID)) + " Recipes"; }
    }
    ...
    protected void buildRecipes() {
        ...
        craftSeven(List.of(ModBlocks.TOP_ELEVATOR.get(), Items.WHITE_WOOL));
        // ** ENCHANTMENT recipes **
        ...
        craftSevenItems(List.of(ModBlocks.TOP_GENERATOR.get(), ModBlocks.CRAFTING_PLUS.get(),
    ...
    protected void kaupenFurnace(@NotNull String group, @NotNull CookingBookCategory category,
        ...
        new KaupenFurnaceRecipeBuilder(group, category, ingredient,
                                      ...
                                      .save(this.output, Top.MOD_ID + ":" + getItemName(result) + "_from_kaupen_furnace");
    }
    ...
    protected void growthChamberRecipe(List<ItemLike> items) {
        ...
        new GrowthChamberRecipeBuilder(Ingredient.of(input), new ItemStack(output))
                                                 ...
                                                 .save(this.output, Top.MOD_ID + ":" +
                                                       getItemName(output) + "_from_growth_chamber");
    }
    ...
    protected <T extends AbstractCookingRecipe>
        ...
        for (ItemLike itemlike : itemLikes) {
            SimpleCookingRecipeBuilder.generic(Ingredient.of(itemlike), category, result, experience, cookingTime,
                                      ...
                                      .save(this.output, Top.MOD_ID + ":" + getItemName(result) +
