...
public class ModModelProvider extends ModelProvider {
    public ModModelProvider(PackOutput output) { super(output, Top.MOD_ID); }
    ...
    protected void registerModels(@NotNull BlockModelGenerators blockModels, @NotNull ItemModelGenerators itemModels) {
        ...
        blockModels.createTrivialCube(ModBlocks.TOP_ELEVATOR.get());
        blockModels.createTrivialCube(ModBlocks.TOP_GENERATOR.get());
        ...
        alternateItemTexture(itemModels, ModItems.SPECIAL_BOTTLE.get());
        ...
        // ** CUSTOM Fishing Rod **
        itemModels.generateFishingRod(ModItems.TOP_FISHING_ROD.get());
    ...
    @Override
    public @NotNull String getName() { return splitWord(itemLines(Top.MOD_ID)) + " Models"; }
}