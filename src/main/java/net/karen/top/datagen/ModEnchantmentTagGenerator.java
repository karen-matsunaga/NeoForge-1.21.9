...
public class ModEnchantmentTagGenerator extends EnchantmentTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        ...
        this.tag(EnchantmentTags.BOOTS_EXCLUSIVE).addOptional(ModEnchantments.DASH)
    ...
    @Override
    public @NotNull String getName() { return splitWord(itemLines(Top.MOD_ID)) + " Enchantment Tags"; }
}