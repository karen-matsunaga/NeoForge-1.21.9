...
public class ModItemTagGenerator extends VanillaItemTagsProvider {
    ...
    protected void addTags(HolderLookup.@NotNull Provider provider) {
        ...
        // CUSTOM Fishing Rod
        this.tag(Tags.Items.TOOLS_FISHING_ROD).add(ModItems.TOP_FISHING_ROD.get());
        this.tag(ItemTags.FISHING_ENCHANTABLE).add(ModItems.TOP_FISHING_ROD.get());
    ...
    @Override
    public @NotNull String getName() { return splitWord(itemLines(Top.MOD_ID)) + " Item Tags"; }
}