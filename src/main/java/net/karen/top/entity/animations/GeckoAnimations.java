package net.karen.top.entity.animations;
...
public class GeckoAnimations {
    public static final AnimationDefinition ANIM_GECKO_IDLE =
    ...
    public static final AnimationDefinition ANIM_GECKO_SLEEP =
           AnimationDefinition.Builder.withLength(0f).looping()
            .addAnimation("Body",
                    new AnimationChannel(AnimationChannel.Targets.POSITION,
    ...
    public static final AnimationDefinition ANIM_GECKO_SWIM =
